export interface Plant {
  ...
  sunNeeds: string;
  waterNeeds: string;
  // Water zone per the Strong Cities LA permaculture model (wet/medium/dry),
  // classified from waterNeeds above: "Very low"/"Low" -> dry, "Moderate" ->
  // medium, streamside/riparian species -> wet. Used for the water-zone
  // filter, doubling this catalog as the "zone-based plant selector" piece
  // of Strong Cities LA (see plan.md Section 11).
  waterZone: "wet" | "medium" | "dry";
